...
<table width="409" border="0">
  ...
  <tr>
    <th width="186" scope="row"><div align="right" class="style5">UserName:</div></th>
    <td width="213">
        <% String a= (String) session.getAttribute("s1"); %>
        <input name="userid" type="text" id="userid" value='<%=a%>' readonly/>      </td>
  </tr>
  <tr>
    <th scope="row"><div align="right" class="style5">Details Of Suspect:</div></th>
    <td>
  ...
  <tr>
    <th scope="row"><div align="right" class="style5">Type of Complaint:</div></th>
    <td>

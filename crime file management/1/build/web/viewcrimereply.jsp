    ...
    try
            {
                ...
                ResultSet rs = st.executeQuery("select user1,crimeid,takeaction from takecrimeaction where user1='" + c1 + "'");
                while (rs.next()) {
                    a = rs.getString("user1");
        ...
        %>   
              <table width="376" border="1">
                <tr>
                  ...
                  <td width="197"><label>
                          <input type="text" name="user"  value='<%=a%>' readonly/>
                  </label></td>
                </tr>
                <tr>
                  <td>Crimeid</td>
                  <td><label>
                          <input type="text" name="crimeid" value='<%=b%>' readonly/>
                  </label></td>
                </tr>
                <tr>
                  <td>Take Action </td>
                  <td><label>
                          <input type="text" name="takeaction" value='<%=c%>' readonly/>
                  </label></td>
                </tr>
              </table>
			</form>
        ...
        <div id="colOne">
                                    ...
                                    <form id="form1" method="post" action="viewadminreply.jsp">
                                        <%
            try {
                 String a = null;
                String b = null;
        ...
        Statement st = con1.createStatement();
                ...
                String userid = "", dsus = "", des = "", dat = "", crimetype = "";
                                        ...
                                        <table width="495" height="49" border="1">
                                            <tr>
                                                <td width="86" height="43" ><span class="style5">Username</span></td>
                                                <td width="89"><span class="style5">Complaintid</span></td>
                                                <td width="84"><span class="style5">Action</span></td>
                                            </tr>
                                            <%
                                            while (rs.next()) {
                                                a = rs.getString("user1");

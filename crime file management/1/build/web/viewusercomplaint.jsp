...
.style5 {color: #990000}
    ...
    <body>
        ...
        Statement st = con1.createStatement();
                ResultSet rs = st.executeQuery("select * from admincomplaint order by Datc desc");
                String userid = "", dsus = "", des = "", dat = "", crimetype = "";
                                        ...
                                        <table width="495" height="49" border="1">
                                            ...
                                            while (rs.next()) {
                                                ...
                                                String c = rs.getString("complaintid");
                                                ...
                                                out.println("<td><a href='takeaction.jsp?id=" +c+"'>Reply</a></td>");
